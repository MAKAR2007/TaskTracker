  ...
  return (
    <>
      <div className="isolate  ">
        <div className="relative isolate -z-10 h-full bg-gradient-to-b  from-bgmain-100 p-4 pt-14">
          <div
            className="absolute inset-y-0 right-2/3 -z-10 -mr-96 h-full w-[200%] origin-top-right skew-x-[-25deg] bg-white  shadow-accent-600/10 ring-1 ring-indigo-50 sm:-mr-80 lg:-mr-96"
            aria-hidden="true"
          />
